...
| Name | Value |
|---|---|
| `TARGET_PRICES` | `880,900`（你的目标金价，逗号分隔） |
...
**Settings → Secrets and variables → Actions → Variables → `TARGET_PRICES`**
改成你要的价位，比如 `850,920,950`，保存后**下一次 cron 触发即生效**。
